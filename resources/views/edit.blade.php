                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active" id="Basic" style="position:relative; top:10px">
                                <div class="form-group{{ $errors->has('surname') ? ' has-error' : '' }} form-group{{ $errors->has('firstname') ? ' has-error' : '' }} form-group{{ $errors->has('lastname') ? ' has-error' : '' }}">
                                    ...
                                    <fieldset>
                                        <div class="col-md-3 inline-fluid">
                                            <input id="name" type="text" class="form-control" name="surname" value="{{ old('surname')?old('surname') : Auth::user()->surname }}" placeholder="Surname">
                                        ...
                                        <div class="col-md-3 inline-fluid">
                                            <input id="name" type="text" class="form-control" name="firstname" value="{{ old('firstname')?old('firstname') : Auth::user()->firstname }}" placeholder="First Name">
                                        ...
                                        <div class="col-md-3 inline-fluid">
                                            <input id="name" type="text" class="form-control" name="lastname" value="{{ old('lastname')? old('lastname') : Auth::user()->lastname}}" placeholder="Last Name">
                                ...
                                <div class= "form-group{{ $errors->has('mob1') ? ' has-error' : '' }} form-group{{ $errors->has('mob2') ? ' has-error' : '' }}">
                                    ...
                                    <fieldset>
                                        <div class="col-md-5 inline-fluid">
                                            <input id="Mobile_No" type="number" class="form-control" name="mob1" value="{{ old('mob1')?old('mob1'): Auth::user()->mob1}}" placeholder="Mobile No.(1)">
                                            @if ($errors->has('mob1'))
                                                <span class="help-block">
                                        ...
                                        <div class="col-md-4 inline-fluid ">
                                            <input id="Mobile_No" type="number" class="form-control" name="mob2" value="{{ old('mob2')?old('mob2'): (Auth::user()->mob2)?Auth::user()->mob2:'' }}" placeholder="Mobile No.(2)">
                                            <!-- {{ old('mob2')}} or Auth::user()->mob2" -->
                                            @if ($errors->has('mob2'))
                                                <span class="help-block">
                                ...
                                <div class="form-group{{ $errors->has('whatsapp') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-6">
                                        <input id="What’sApp_no" type="number" class="form-control" name="whatsapp" value="{{ old('whatsapp')?old('whatsapp'): (Auth::user()->whatsapp)?Auth::user()->whatsapp:'' }}">
                                ...
                                <div class="form-group{{ $errors->has('fb_email') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-6">
                                        <input id="fb_email" type="email" class="form-control" name="fb_email" value="{{ old('fb_email')?old('fb_email') : Auth::user()->fb_email}}">
                                ...
                                <div class="form-group{{ $errors->has('bdate') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-6">
                                        <input id="bdate" type="date" class="form-control" name="bdate" value="{{ old('bdate')?old('bdate'):Auth::user()->bdate}}">
                            ...
                            <div class="tab-pane" id="College" style="position:relative; top:10px">
                                ...
                                <div class="form-group{{ $errors->has('college_name') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-6">
                                        <input id="college_name" type="text" class="form-control" name="college_name" value="{{ old('college_name')?old('college_name') : Auth::user()->college_name}}">
                                ...
                                <div class="form-group{{ $errors->has('period_from') ? ' has-error' : '' }} form-group{{ $errors->has('period_to') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        {{Form::selectYear('period_from',1970,date("Y"),Auth::user()->period_from or'From', ['class' => "form-control",'placeholder'=>'From','id'=>'period'])}}
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        {{Form::selectYear('period_to',1973,date("Y")+6,Auth::user()->period_to or 'To', ['class' => "form-control",'placeholder'=>'To','id'=>'period'])}}
                            ...
                            <div class="tab-pane" id="Staying" style="position:relative; top:10px">
                               <!-- residence -->
                                ...
                                <div class="form-group{{ $errors->has('per_addr') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-6">
                                        <textarea id="per_addr" row="3" class="form-control" name="per_addr">{{ old('per_addr')?old('per_addr'):Auth::user()->per_addr  }}</textarea>
                                ...
                                <?php $pin_det = \DB::table('pincodes')->find(Auth::user()->per_pin_id);?>
                                    
                                    <div class="col-md-3 col-md-offset-4">
                                        <input id="per_pin" type="text" class="form-control" name="per_pin" value="{{ old('per_pin')?old('per_pin'):$pin_det->pincode}}" placeholder="Pincode">
                                    ...
                                    <div class="col-md-3">
                                        <input id="per_state" type="text" class="form-control" name="per_state" value="{{ old('per_state')?old('per_state'):$pin_det->state }}" placeholder="State">
                                ...
                                <div class="form-group{{ $errors->has('per_city') ? ' has-error' : '' }} form-group{{ $errors->has('per_postoffice') ? ' has-error' : '' }}">
                                    <div class="col-md-3 col-md-offset-4">
                                        <input id="per_city" type="text" class="form-control" name="per_city" value="{{ old('per_city')?old('per_city'):$pin_det->city}}" placeholder="City/Town">
                                    ...
                                    <div class="col-md-3">
                                        <input id="per_postoffice" type="text" class="form-control" name="per_postoffice" value="{{ old('per_postoffice')?old('per_postoffice'):$pin_det->postoffice }}" placeholder="Post Office">
