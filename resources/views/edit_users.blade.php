...
<?php
    ...
    $page_desc="Update {$user->firstname} details";
?>
@stop
            ...
            <div class="panel panel-default">
                ...
                <!-- --------------Added in main layout------------- -->
                  ...
                  @endif--}}
                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/admin/update_user/') }}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <!-- Admin_Special Expandable  -->
                        <div class="box box-success">
                            <div class="box-header with-border">
                              <h3 class="box-title">Admin Special</h3>
                            ...
                            <!-- Type name -->
                                <div class="form-group{{ $errors->has('type1') ? ' has-error' : '' }}">
                                    <label for="type1" class="col-md-4 control-label">Select Type</label>
                                    <div class="col-md-6">
                                        <select class="form-control" id="type1" name="type1" onfocus="select_option(this.id,&apos;{{ old('type1')? old('type1') : $user->type1 }}&apos;)" >
                                ...
                                <div class="form-group{{ $errors->has('is_admin') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-6">
                                        <select class="form-control" id="is_admin" name="is_admin" onfocus="select_option(this.id,{{old('is_admin')?old('is_admin'):$user->is_admin}})">
                                ...
                                <div class="form-group{{ $errors->has('comments') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-6">
                                        <textarea id="comments" rows="4" class="form-control" name="comments" value="{{ old('comments')? old('comments') : $user->comments }}" placeholder="{{ old('comments')? old('comments') : $user->comments }}&#13;&#10;Please add some comments about the user"></textarea>
                            ...
                            <div class="box-body" style="display: none;">
                              <div class="form-group{{ $errors->has('college_name') ? ' has-error' : '' }}">
                                ...
                                <div class="form-group{{ $errors->has('period_from') ? ' has-error' : '' }} form-group{{ $errors->has('period_to') ? ' has-error' : '' }}">
                                    ...
                                    <fieldset>
                                        <div class="col-md-3">
                                            {{Form::selectYear('period_from',1970,date("Y"),'From', ['class' => "form-control",'placeholder'=>'From','id'=>'period_from', 'onfocus'=> "select_option(this.id, old('period_from')?old('period_from'):$user->period_from)" ])}}
                                        </div>

                                        <div class="col-md-3">
                                            {{Form::selectYear('period_to',1973,date("Y")+6,'To', ['class' => "form-control",'placeholder'=>'To','id'=>'period_to' , 'onfocus'=> "select_option(this.id,old('period_to')?old('period_to'):$user->period_to)"])}}
                                        </div>
                            ...
                            <div class="box-body" style="display: none;">
                              <!-- Connected to center -->
                               ...
                               <div class="container-fluid">
                                    ...
                                    <label for="profile_pic" class="col-md-4 control-label">Change profile pic</label>
