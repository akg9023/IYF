		            ...
		            <div class="row">
		                <div class="col-lg-12">
		                    <div id="portfoliolist">
		                    	...
		                    	<?php $result = DB::table('centers')->get() ?>
			                        <div class="portfolio identity" data-cat="identity" href="#portfolioModal1" data-toggle="modal">
			                            <div class="portfolio-wrapper">
			                                <img src="{{asset('/assets/images/demo/mockups/600x399/IIT_Kharagpur_Logo.jpg')}}" alt="">
			                                <div class="caption">
			                                    <div class="caption-text">
			                                        <a class="text-title">{{$result[0]->name}}</a>
			                                        <span class="text-category">{{$result[0]->city}}</span>
			                                    </div>
			                        ...
			                        <div class="portfolio identity" data-cat="identity" href="#portfolioModal1" data-toggle="modal">
			                            <div class="portfolio-wrapper">
			                                <img src="{{asset('/assets/images/demo/mockups/600x399/NIT_Durgapur_Logo.jpg')}}" alt="">
			                                <div class="caption">
			                                    <div class="caption-text">
			                                        <a class="text-title">{{$result[1]->name}}</a>
			                                        <span class="text-category">{{$result[1]->city}}</span>
			                                    </div>
			                                    <div class="caption-bg"></div>
			                                </div>
			                            </div>
			                        ...
			                        <div class="portfolio identity" data-cat="identity" href="#portfolioModal1" data-toggle="modal">
			                            <div class="portfolio-wrapper">
			                                <img src="{{asset('/assets/images/demo/mockups/600x399/indianschoolofmines.jpg')}}" alt="">
			                                <div class="caption">
			                                    <div class="caption-text">
			                                        <a class="text-title">{{$result[2]->name}}</a>
			                                        <span class="text-category">{{$result[2]->city}}</span>
			                                    </div>
			                                    <div class="caption-bg"></div>
			                                </div>
			                            </div>
			                        ...
			                        <div class="portfolio identity" data-cat="identity" href="#portfolioModal1" data-toggle="modal">
			                            <div class="portfolio-wrapper">
			                                <img src="{{asset('/assets/images/demo/mockups/600x399/hit_logo.jpg')}}" alt="">
			                                <div class="caption">
			                                    <div class="caption-text">
			                                        <a class="text-title">{{$result[3]->name}}</a>
			                                        <span class="text-category">{{$result[3]->city}}</span>
			                                    </div>
			                                    <div class="caption-bg"></div>
			                                </div>
			                            </div>
			                        ...
			                        <div class="portfolio identity" data-cat="identity" href="#portfolioModal1" data-toggle="modal">
			                            <div class="portfolio-wrapper">
			                                <img src="{{asset('/assets/images/demo/mockups/600x399/bcroy.jpeg')}}" alt="">
			                                <div class="caption">
			                                    <div class="caption-text">
			                                        <a class="text-title">{{$result[4]->name}}</a>
			                                        <span class="text-category">{{$result[4]->city}}</span>
			                                    </div>
			                                    <div class="caption-bg"></div>
			                                </div>
			                            </div>
			                        ...
			                        <div class="portfolio identity" data-cat="identity" href="#portfolioModal1" data-toggle="modal">
			                            <div class="portfolio-wrapper">
			                                <img src="{{asset('/assets/images/demo/mockups/600x399/nit_jam.jpg')}}" alt="">
			                                <div class="caption">
			                                    <div class="caption-text">
			                                        <a class="text-title">{{$result[5]->name}}</a>
			                                        <span class="text-category">{{$result[5]->city}}</span>
			                                    </div>
			                                    <div class="caption-bg"></div>
			                                </div>
			                            </div>
